...
settings.fit_circuit = 'RCRC' ; % select the circuit to fit 'RCRC'
...
settings.min_allow_freq = 5; % (1e-3) [Hz] minimum allowable measurment frequency

settings.smooth_freq_data = 1; % use the matlab smooth function on the real and imaginary data

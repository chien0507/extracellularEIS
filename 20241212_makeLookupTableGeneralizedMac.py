...
#%% run on python 3.9.7
# Code written by Athena Chien to automatically make lookup table from raw EIS files in a folder on a Mac
# (see 20241212_makeLookupTableGeneralizedPC.py if you are using a PC)
...
directoryToSplit = '/Users/myuser/rawData/'+expName+'/'
...
rawDestinationFold = '/Users/myuser/extracellularEIS/raw data/' # where the fit is occurring
lookupDestinationFold = '/Users/myuser/extracellularEIS/lookup table/'
...
# copies all raw data files to the rawDestinationFold
for file in os.listdir(directoryToSplit):
    if "_freq" in file:

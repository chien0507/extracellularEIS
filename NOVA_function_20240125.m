%% NOVA SUMMARY TABLE
function [T_master,T_final,T_summary] = NOVA_function_20240125(lookup_table,remove_all_but_last_meas_of_day,settings)
        ...
        for n = 1:num_meas
            ...
            switch settings.initial_guess_method
                ...
                case 'grid'
                    ...
                    C_range = linspace(1, settings.C_max, settings.grid_size);
